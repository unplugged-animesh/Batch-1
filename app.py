...
def signup():
    if request.method=="POST":
        ...
        try:      
            ...
            db.session.rollback()
            flash('Username or Email already exists.Please choose a diff username or email')
...
@app.route('/admin/<int:curr_login_id>/edit_catgory/<int:category_id>',methods=["GET","POST"])
